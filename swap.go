...
func (c *Client) Swap(ctx context.Context, network int64, fromTokenAddress, toTokenAddress, amount, fromAddress string, slippage int64, opts *SwapOpts) (*SwapRes, int, error) {
	endpoint := "/swap"
